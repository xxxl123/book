					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal" action="/books/selectBookServlet.bk"
									method="post">
									...
									<div class="col-lg-3 form-group">
									<button type="button" class="btn btn-primary" id="btn_import"
...
<c:forEach items="${list}" var="bk" varStatus="index">
				<tr>
					...
					onclick="showInfo2('${bk.bid}','${bk.card}','${bk.type}','${bk.name}','${bk.autho}',
					'${bk.press}','${bk.num}')">修改</button>
					<button type="button" class="btn btn-danger btn-xs"
					onclick="deletebook(${bk.bid})">删除</button></td>
				</tr>
	</c:forEach>
							<%-- <!---在此插入信息-->
							<%
				...
				<ul class="pagination">
                    <li><a href="#">«</a></li>
                    <li><a href="/books/tobookshow.bk">1</a></li>
                    <li><a class="active" href="/books/tobookshowByid.bk?id=2">2</a></li>
                    <li><a href="/books/tobookshowByid.bk?id=3">3</a></li>
                    <li><a href="/books/tobookshowByid.bk?id=4">4</a></li>
                    <li><a href="/books/tobookshowByid.bk?id=5">5</a></li>
                    <li><a href="/books/tobookshowByid.bk?id=6">6</a></li>
                    <li><a href="/books/tobookshowByid.bk?id=7">7</a></li>
                    <li><a href="#">»</a></li>
                </ul>
	...
	<script type="text/javascript">
		...
		function deletebook(bid) {
			con = confirm("是否删除?");
			if(con == true) {
				location.href = "/books/deleteBookServlet.bk?bid=" + bid;
			}
		}
	</script>
	...
	<form class="form-horizontal" method="post"
		action="/books/updateBookServlet.bk">
		<!--保证样式水平不混乱-->
	...
	<!--------------------------------------添加的模糊框------------------------>
	<form class="form-horizontal" method="post"
		action="/books/addBookServlet.bk">
		<!--保证样式水平不混乱-->
		<!-- 模态框（Modal） -->
