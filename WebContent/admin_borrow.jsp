		...
		<div class="row">
			...
			<div class="col-md-2 bootstrap-admin-col-left">
				<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					...
					<li><a href="/books/tobookborrow.br"><i
...
<c:forEach items="${list}" var="br" varStatus="index">
				<tr>
					...
					<td><button type="button" class="btn btn-warning btn-xs"
										onclick="haibook(${br.hid})">还书</button>
									<button type="button" class="btn btn-info btn-xs"
										data-toggle="modal" data-target="#updateModal" id="btn_add"
										onclick="addtime('${br.hid}','${br.endtime}')">延期</button>
					</td>
    ...
    function haibook(hid) {
    	con=confirm("是否还书?"); 
    	if(con==true){
    		location.href = "/books/borrowBookServlet.br?tip=2&show=2&hid="+hid;
    	}
    }
	...
	<form class="form-horizontal" method="post"
		action="/books/addTimeServlet.br">
		<!--保证样式水平不混乱-->
